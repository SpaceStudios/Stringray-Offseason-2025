...
public class ClimbConstants {
  public class PID {
    public static final double[] kP = new double[] {150, 150, 150, 150};
    public static final double[] kI = new double[] {0.0, 0.0, 0.0, 0.0};
    public static final double[] kD = new double[] {0.0, 0.0, 0.0, 0.0};
